 ...
 */
export function generateOAuthScopesDocumentation(): string {
...
export const oauthScopesDocumentation: string = generateOAuthScopesDocumentation();
 ...
 */
export function serveOAuthScopesDocumentation(req: Request, res: Response): void {
